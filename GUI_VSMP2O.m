...
%HOBJECT: O AN ÝÇÝNDE BULUNDUÐUMUZ BÝLEÞENE ULAÞMAK ÝÇÝN KULLANIYORUZ.


handles.output = hObject;%Komut satýrý çýktýsýný seçtik

% datalar güncelleþtirildi.
guidata(hObject, handles);

% Kullanýcý Yanýtý bekleniyor.
jinit=[90;60;-120];
...
% --- Bu fonksiyondan gelen çýktýlar komut satýrýna döndürülür.
function varargout = GUI_VSMP2O_OutputFcn(hObject, eventdata, handles) 
% varargout Çýktý döndürmek için hücre dizisi (see VARARGOUT);
% eventdata  Ýlerde tanýmlanacak datalarý topluyor(Kullanýcýdan aldýðý
% deðerleri komut satýrýna biliriyoruz.
%Handles Bir nesneyi kendine baðlamýþ kaynak görevi görmektedir.
